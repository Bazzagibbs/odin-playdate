...
Synth_Signal_Value :: distinct Handle
Synth_Signal       :: distinct Synth_Signal_Value

Sound_Signal_Step_Proc     :: #type proc "c" (user_data: rawptr, io_frames: ^i32, if_val: ^f32) -> f32
Sound_Signal_Note_On_Proc  :: #type proc "c" (user_data: rawptr, note: MIDI_Note, velocity, length: f32)
...
Api_Sound_Signal_Procs :: struct {
    new_signal:           proc "c" (step: Sound_Signal_Step_Proc, note_on: Sound_Signal_Note_On_Proc, note_off: Sound_Signal_Note_Off_Proc, dealloc: Sound_Signal_Dealloc_Proc, user_data: rawptr) -> Synth_Signal,
...
Synth_Instrument :: distinct Handle
...
Sequence_Track :: distinct Handle
